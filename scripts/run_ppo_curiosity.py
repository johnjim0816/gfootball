...
python scripts/run_ppo_curiosity.py -n 50  -t 50000000 -a -e -b
"""
...
def main(n_cpus, n_gpus, env_name,
    ...
    config = {
        ...
        'num_workers': 0, # Curiosity exploration currently does not support parallelism. `num_workers` must be 0!
